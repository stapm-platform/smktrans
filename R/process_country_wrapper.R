...
process_country <- function(config) {
  ...
  # save main files
  saveRDS(init_data_uncertainty,    file.path(out_dir, "init_data_england_uncertainty.rds"))
  saveRDS(quit_data_uncertainty,    file.path(out_dir, "quit_data_england_uncertainty.rds"))
  saveRDS(relapse_data_uncertainty, file.path(out_dir, "relapse_data_england_uncertainty.rds"))
