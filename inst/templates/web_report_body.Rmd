...
# NOTE: This assumes the Excel file was generated on the SAME day this report is rendered.
# If the Excel files are older, you might need to find the specific file rather than using Sys.Date()
excel_name <- paste0("SmokeStateTransProbs_", config$country, "_", Sys.Date(), ".xlsx")

# CLEAN URL CONSTRUCTION (No brackets or markdown syntax here)
...
if(exists("init_dt") && !is.null(init_dt)) {
  ...
  plot_data <- plot_data[plot_data$age <= 30, ] # Initiation rare after 30
